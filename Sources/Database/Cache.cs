...
using DragonBoyZ.Sources.Base.Template;
using DragonBoyZ.Sources.Application.Server;
...
namespace DragonBoyZ.DatabaseManager
{
    public class Cache
    {
        ...
        public readonly Dictionary<short, DragonBoyZ.Application.Extension.Bo_Mong.BoMong_Task_Template> TASK_BO_MONG = new Dictionary<short, DragonBoyZ.Application.Extension.Bo_Mong.BoMong_Task_Template>();
        ...
        //public readonly List<DragonBoyZ.Sources.Application.Extension.ShopKyGui> SHOP_KY_GUI = new List<DragonBoyZ.Sources.Application.Extension.ShopKyGui>();
