...
namespace DragonBoyZ.Application.Handlers.Character
{
    public class CharacterHandler : ICharacterHandler
    {
        ...
        public void PlusTiemNang(IMonster monster, int damage)
        {
          ...
          //  var CacheLitmit = Cache.Gi().LIMIT_POWERS.FirstOrDefault(i => i.Key == Character.InfoChar.LitmitPower).Value;
            ...
            //}
            if (Character.InfoSet.IsFullSetOcTieu || Character.InfoSet.IsFullSetCadic || Character.InfoSet.IsFullSetThienXinHang) damagePlusPoint *= 10;
                ...
                lock (zone.ItemMaps)
                {
                    ...
                    switch (itemNew.Id)
                    {
                        ...
                        case 378:
                            ...
                            {
                                if (timeserver - Blackball.gI().currMiliTimeStartBlackBall <= 1750000)
                                {
                                    Character.CharacterHandler.SendMessage(Service.ServerMessage("Bạn sẽ được lụm khi 20h30"));
                                    return;
                                }
                            }
