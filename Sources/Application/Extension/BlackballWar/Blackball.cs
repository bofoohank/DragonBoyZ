...
namespace DragonBoyZ.Application.Extension.BlackballWar
{
    public class Blackball
    {
        ...
        public readonly List<int> CostToPlusHp = new List<int>(){100000000, 350000000, 500000000};
        public readonly List<int> PercentPlusHp = new List<int>(){3,5,7};
        public long currTimeEndBlackBall = 21;
        public long currTimeStartBlackBall = 16;
                    ...
                    switch (character.TypeMenu)
                    {
                        ...
                        case 1:
                            switch (select)
                            {
                                ...
                                case 1:
                                case 2:
                                    if (character.InfoChar.Gold < Blackball.gI().CostToPlusHp[select])
                                    {
                                    ...
                                    character.MineGold(Blackball.gI().CostToPlusHp[select]);
